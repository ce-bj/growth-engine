...
export const mockIssuesData: IssueItem[] = [
  ...
  // —— 基础配置（config）- 冷启动任务 ——
  {
    ...
    priority: 'P0',
    title: '域名未绑定',
    description: '请先绑定您的自定义域名，否则网站无法正常访问。',
    dimensionKey: 'config',
    fixMode: 'guide',
  },
  {
    ...
    priority: 'P0',
    title: '基础信息未完善',
    description: '网站名称、联系方式、公司简介等基础信息缺失，影响用户信任。',
    dimensionKey: 'config',
    fixMode: 'guide',
  },
  {
    ...
    priority: 'P1',
    title: '通知渠道未配置',
    description: '未配置邮件/短信/微信通知渠道，无法及时接收线索提醒。',
    dimensionKey: 'config',
    fixMode: 'guide',
  },
  {
    ...
    priority: 'P1',
    title: '搜索引擎未提交',
    description: '未将网站提交至 Google Search Console，影响搜索收录速度。',
    dimensionKey: 'config',
    fixMode: 'guide',
  },
]
